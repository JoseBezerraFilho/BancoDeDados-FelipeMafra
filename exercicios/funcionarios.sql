...
select count(*), departamento from funcionarios
group by departamento order by 1;

-- 21 Func filmes, 53 Func Roupas.
...
/* O gestor de marketing pediu a lista das funcionarias (AS) = FEMININO que trabalhem no departamento de filmes ou no departamento lar. Ele necessita enviar um email para as colaboradoras desses dois setores. OR +  AND */

select count(*), sexo from funcionarios
group by sexo;
-- 491 Feminino, 484 Masculino;
...
-- Use a tecla SHIFT e role para selecionar.
